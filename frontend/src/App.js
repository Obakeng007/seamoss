...
import { LandingPage, LoginPage, SignupPage, ForgotPasswordPage, ResetPasswordPage, HomePage, ProductDetailsPage, CartPage, UserProfilePage, CheckoutPage, OrderSuccessPage, UserOrdersPage, ProductUpdatePage, AddProductPage, AdminOrdersPage, WishlistPage, OtpVerificationPage} from './pages';
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route exact path='/seasmoss' element={<LandingPage/>}/>
